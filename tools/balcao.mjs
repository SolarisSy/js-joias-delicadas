/* ===========================================================
   BALCÃO DE POSTAGEM — a casca comum das filas de canal

   O Marketplace e o Pinterest pedem a mesma coisa do dono:
   uma peça por vez, com a foto pronta, o texto pronto e um
   lugar para marcar o que já saiu. Quem monta essa casca — o
   visual, o placar, os filtros, o copiar e a memória do
   navegador — é este módulo; cada gerador só descreve a ficha
   do seu canal.
   =========================================================== */
...
export const CHECK = '<svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8.6 6 12.5 14 3.5"/></svg>';
export const BAIXAR = '<svg width="13" height="13" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v8.5M4.5 7.5 8 11l3.5-3.5M2.5 13.5h11"/></svg>';

/* Campo de texto pronto para copiar. `conta` mostra o limite do canal. */
export const campo = (rotulo, texto, conta) => `<div class="campo">
...
export const ESTILO = String.raw`:root{
...
/* `chave` separa o que já foi publicado em cada canal: as duas filas
   moram no mesmo navegador e não podem dividir a mesma marcação. */
export const comportamento = (chave) => String.raw`const CHAVE = '__CHAVE__';
